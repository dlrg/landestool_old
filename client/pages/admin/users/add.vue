                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-success btn-sm float-right" type="submit">Hinzufügen</button>
                            </div>
                            <div class="card-body">
               ...
               <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-xl-1 col-form-label" for="agreement">Einverständnis</label>
                                 ...
                                 <div class="form-group row">
                                    <label class="col-xl-1 col-form-label" for="agb">Helfer-AGB</label>
