              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                      <i class="ca ca-anchor"></i>Rollenverteilung für {{ user.firstname }} {{ user.lastname }}
                  ...
                  <div class="card-body">
                    <div class="form-group row" v-for="(item, index) in user.role" :key="'roles'+index">
                        ...
                        <div class="delete-button col-xl-1 offset-xl-3">
                          <button v-if="!user.role || user.role.length >1" type="button" class="btn btn-sm btn-danger float-right" @click.stop="remove(index)">Löschen</button>
                        </div>
                    </div>
