                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" id="text-input" v-model="program.name" name="text-input" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9 text-right">
                                    <div class="select-wrapper">
                                        <select class="form-control  float-left" name="selectForm" id="statusSelect" v-model="program.status">
                                            ...
                                            <option :value="'planing'">Geplant</option>
                                            <option :value="'deactivate'">Storniert</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
