                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4">
                                    <p class="form-control-static mt-2 mb-0">{{program.dates.start | dateFormatter('DD.MM.YYYY')}} - {{program.dates.end | dateFormatter('DD.MM.YYYY')}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <p class="form-control-static mt-2 mb-0">{{program.dates.duration}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <p class="form-control-static mt-2 mb-0">{{program.dates.deadline | dateFormatter('DD.MM.YYYY')}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <p class="form-control-static mt-2 mb-0">{{program.dates.comment}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
